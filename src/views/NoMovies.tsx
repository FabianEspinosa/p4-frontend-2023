import './../assets/noMovies.scss'

interface props {
    notFound: number;
}

function NoMovies({ notFound }: props) {
    return (
        <div className="preloader" style={{ opacity: 1 }}>
            <svg version="1.1" id="sun" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" style={{ opacity: 1, marginLeft: "0px", marginTop: "0px" }}>
                <g>
            ...
            <svg version="1.1" id="cloud" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10">
